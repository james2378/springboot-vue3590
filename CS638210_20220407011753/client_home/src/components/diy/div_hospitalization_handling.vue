<template>
	<div class="diy_details_box diy_div_hospitalization_handling">
		<div class="warp">
			<div class="container">
	...
	export default {
		...
		methods: {
			...
			change_praise(obj) {
				...
				var query = {
					source_table: "hospitalization_handling",
					source_field: "hospitalization_handling_id",
					source_id: this.obj["hospitalization_handling_id"],
					user_id
				};
				...
				if (this.state_praise) {
					...
					this.$get('~/api/praise/del?', query, (res) => {
						if(res.result){
							...
							this.$post('~/api/hospitalization_handling/set?hospitalization_handling_id=' + _this.obj["hospitalization_handling_id"], {
								praise_len
							}, (res) => {
								if(res.result){
