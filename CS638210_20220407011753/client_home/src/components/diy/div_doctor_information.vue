<template>
	<div class="diy_details_box diy_div_doctor_information">
		<div class="warp">
			<div class="container">
				...
				<div class="row">
						...
						<!-- 图片 -->
							...
							<div class="details_btn_wrap">
								<button class="btn btn-primary details_btn" v-if="$check_action('/registration_reservation/edit','add')" @click="to_form('/registration_reservation/edit')" >预约 </button>
							</div>
						<!-- 富文本 -->
