<template>
	<div class="diy_details_box diy_div_hospitalization_notice">
		<div class="warp">
			<div class="container">
	...
	export default {
		...
		methods: {
			...
			change_praise(obj) {
				...
				var query = {
					source_table: "hospitalization_notice",
					source_field: "hospitalization_notice_id",
					source_id: this.obj["hospitalization_notice_id"],
					user_id
				};
				...
				if (this.state_praise) {
					...
					this.$get('~/api/praise/del?', query, (res) => {
						if(res.result){
							...
							this.$post('~/api/hospitalization_notice/set?hospitalization_notice_id=' + _this.obj["hospitalization_notice_id"], {
								praise_len
							}, (res) => {
								if(res.result){
