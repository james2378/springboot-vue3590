...
const routes = [
	...
	//医生信息列表路由
	{
		path: '/doctor_information/list',
		name: '/doctor_information_list',
		component: () => import('../views/doctor_information/list.vue')
	},
	//医生信息详情路由
	{
		path: '/doctor_information/details',
		name: '/doctor_information_details',
		component: () => import('../views/doctor_information/details.vue')
	},
	//挂号预约添加路由
	{
