		...
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','doctor_number') || $check_field('add','doctor_number') || $check_field('set','doctor_number')" :xs="24" :sm="12" :lg="8">
				<el-form-item label="医生编号" prop="doctor_number">
					<el-input id="doctor_number" v-model="form_sub['doctor_number']" placeholder="请输入医生编号"
							  v-if="user_group === '管理员' || (form_sub['doctor_id'] && $check_field('set','doctor_number')) || (!form_sub['doctor_id'] && $check_field('add','doctor_number'))"></el-input>
					<div v-else-if="$check_field('get','doctor_number')">{{form_sub['doctor_number']}}</div>
				</el-form-item>
			</el-col>
			<el-col v-if="user_group === '管理员' || $check_field('get','name_of_doctor') || $check_field('add','name_of_doctor') || $check_field('set','name_of_doctor')" :xs="24" :sm="12" :lg="8">
				<el-form-item label="医生姓名" prop="name_of_doctor">
					<el-input id="name_of_doctor" v-model="form_sub['name_of_doctor']" placeholder="请输入医生姓名"
							  v-if="user_group === '管理员' || (form_sub['doctor_id'] && $check_field('set','name_of_doctor')) || (!form_sub['doctor_id'] && $check_field('add','name_of_doctor'))"></el-input>
					<div v-else-if="$check_field('get','name_of_doctor')">{{form_sub['name_of_doctor']}}</div>
				</el-form-item>
			</el-col>
			<el-col :xs="24" :sm="12" :lg="8">
				<el-form-item>
